...
public class TestByteArrayStopCodec {
	...
	public void test1() throws IOException {
		...
		ByteArrayStopEncoding.ByteArrayStopCodec c = new ByteArrayStopEncoding.ByteArrayStopCodec((byte) 0, null, bos);
		...
		c = new ByteArrayStopEncoding.ByteArrayStopCodec((byte) 0, new BufferedInputStream(gis), null);
	...
	public void test2() throws IOException {
		...
		ExternalByteArrayCodec c = new ExternalByteArrayCodec(bos, null);
		int maxRecords = 100000;
		int counter = 0;
