...
import static net.sf.cram.encoding.rANS.rans_byte.RansDecAdvanceSymbol;
import static net.sf.cram.encoding.rANS.rans_byte.RansDecAdvanceSymbolStep;
import static net.sf.cram.encoding.rANS.rans_byte.RansDecGet;
import static net.sf.cram.encoding.rANS.rans_byte.RansDecRenorm;
...
public class rANS_Decoder1_4way {
	...
	void readStats2(ByteBuffer cp, Decoder0.ari_decoder[] D, RansSymbol[][] syms) {
	...
	ByteBuffer rans_uncompress_O1(ByteBuffer in, ByteBuffer out_buf) {
		...
		// System.out.printf("rans: %d, %d, %d, %d\n", rans0, rans1, rans2,
		// rans7);
