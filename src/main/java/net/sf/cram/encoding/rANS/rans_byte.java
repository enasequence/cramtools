...
public class rans_byte {
	...
	public static class RansSymbol {
	...
	public static int RansEncPutSymbol(int r, ByteBuffer pptr, RansSymbol sym, int scale_bits) {
		// renormalize
		if (r < 0)
	...
	public static int RansDecAdvance(int r, ByteBuffer pptr, int start, int freq, int scale_bits) {
